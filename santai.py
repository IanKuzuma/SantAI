...
- Total Pinjaman: Rp {total_loan_amount:,.0f}
- Total Angsuran: Rp {total_monthly_installment:,.0f}/bulan
- Rasio DSR: {debt_to_income_ratio:.1f}%

**LENDER:**
""" + "\n".join([f"- {lender['name']}: Rp {lender.get('loan_amount', 0):,.0f}" 
...
**TUGAS:**
1. Analisis status legalitas SETIAP lender HANYA berdasarkan dokumen di atas
2. Jika tidak ditemukan: "TIDAK TERCANTUM DALAM DAFTAR OJK"
3. Berikan analisis finansial yang empatik
4. Berikan rekomendasi langkah konkret
5. Gunakan bahasa yang menenangkan
